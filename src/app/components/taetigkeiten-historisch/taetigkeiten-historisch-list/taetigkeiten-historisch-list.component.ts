...
import { TaetigkeitenHistorischDetailComponent } from '../taetigkeiten-historisch-detail/taetigkeiten-historisch-detail.component';
...
@Component({
  selector: 'app-taetigkeiten-historisch-list',
  imports: [
    FormsModule,
    MatTableModule,
    MatSortModule,
...
export class TaetigkeitenHistorischListComponent {
