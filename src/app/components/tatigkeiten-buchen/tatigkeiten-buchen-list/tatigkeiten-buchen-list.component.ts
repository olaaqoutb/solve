...
@Component({
  selector: 'app-tatigkeiten-buchen-list',
imports: [
    FormsModule,
    MatTableModule,
    MatSortModule,
    ...
    templateUrl: './tatigkeiten-buchen-list.component.html',
  styleUrl: './tatigkeiten-buchen-list.component.scss'
})
export class TatigkeitenBuchenListComponent {
...
private applySorting(data: ApiPerson[]): ApiPerson[] {
 ...
 getSortIcon(column: string): string {
  ...
  console.log('Navigate to details:', row);
    ...
    this.router.navigate(['/book-activities', uiIndex]);
}
}
