...
@Component({
 ...
 imports: [
    ...
    MatCheckboxModule,
    HttpClientModule
  ],  templateUrl: './tatigkeiten-historisch-list.component.html',
  styleUrl: './tatigkeiten-historisch-list.component.scss'
})
 ...
 private applySorting(data: ApiPerson[]): ApiPerson[] {
  ...
  getSortIcon(column: string): string {
   ...
   console.log('Navigate to details:', row);
     ...
     this.router.navigate(['/activities-history', uiIndex]);
 }
 }
