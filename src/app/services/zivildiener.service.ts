...
@Injectable({
  providedIn: 'root' //allows for all components to use this service without needing to add it to a module's providers array
})
export class ZivildienerService {

 private listUrl="stempelzeit-list.json"
private detailUrl="zivildiener-details.json"
